...
public section.
  ...
  data VALUE2 type STRING .
    ...
    "! @parameter I_MSGV1 | <p class="shorttext synchronized" lang="en">Message attribute 1</p>
    "! @parameter I_MSGV2 | <p class="shorttext synchronized" lang="en">Message attribute 2</p>
