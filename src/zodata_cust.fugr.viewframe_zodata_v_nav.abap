*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZODATA_V_NAV
*   generation date: 21.01.2021 at 13:27:52
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZODATA_V_NAV        .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZODATA_V_NAV'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZODATA_V_NAV_EXTRACT
TOTAL = ZODATA_V_NAV_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZODATA_V_NAV'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZODATA_V_NAV-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZODATA_V_NAV_EXTRACT
TOTAL = ZODATA_V_NAV_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZODATA_V_NAV-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZODATA_V_NAV'
...
TOTAL = ZODATA_V_NAV_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZODATA_V_NAV-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZODATA_V_NAV-UPD_FLAG NE SPACE.
