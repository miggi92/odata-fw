---
title: ZCL_ODATA_FW_SADL
description: SADL Configuration class
---
...
Generates the SADL XML from the entity and property customizing. This XML is used by the SAP SADL framework to enable features like analytical queries.

## Related

- [SADL Documentation](/sadl) for usage details
