...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZODATA_V_ENTITY'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZODATA_V_ENTITY_EXTRACT
TOTAL = ZODATA_V_ENTITY_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZODATA_V_ENTITY'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZODATA_V_ENTITY-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZODATA_V_ENTITY_EXTRACT
TOTAL = ZODATA_V_ENTITY_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZODATA_V_ENTITY-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZODATA_V_ENTITY'
...
TOTAL = ZODATA_V_ENTITY_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZODATA_V_ENTITY-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZODATA_V_ENTITY-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZODATA_V_ENTITY'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZODATA_V_ENTITY-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZODATA_V_ENTITY_EXTRACT
TOTAL = ZODATA_V_ENTITY_TOTAL
