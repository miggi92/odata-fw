*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZODATA_V_ACTPARA
*   generation date: 03.05.2021 at 17:03:33
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZODATA_V_ACTPARA    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZODATA_V_ACTPARA'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZODATA_V_ACTPARA_EXTRACT
TOTAL = ZODATA_V_ACTPARA_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZODATA_V_ACTPARA'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZODATA_V_ACTPARA-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZODATA_V_ACTPARA_EXTRACT
TOTAL = ZODATA_V_ACTPARA_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZODATA_V_ACTPARA-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZODATA_V_ACTPARA'
...
TOTAL = ZODATA_V_ACTPARA_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZODATA_V_ACTPARA-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZODATA_V_ACTPARA-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZODATA_V_ACTPARA'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZODATA_V_ACTPARA-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZODATA_V_ACTPARA_EXTRACT
TOTAL = ZODATA_V_ACTPARA_TOTAL
